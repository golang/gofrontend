...
def RietveldSetup(ui, repo):
	...
	try:
		# FIXME(cw): this path is different to what is used if
		# the main Go repository; make things work either way
		repo_config_path = repo.root + '/support/codereview/codereview.cfg'
